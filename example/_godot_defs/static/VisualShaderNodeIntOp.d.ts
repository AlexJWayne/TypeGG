 ...
 *
*/
  new(): VisualShaderNodeIntOp; 
  static "new"(): VisualShaderNodeIntOp 
...
operator: int;
  ...
  connect<T extends SignalsOf<VisualShaderNodeIntOp>>(signal: T, method: SignalFunction<VisualShaderNodeIntOp[T]>): number;
