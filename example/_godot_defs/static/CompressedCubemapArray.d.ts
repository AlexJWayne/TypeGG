 ...
 *
*/
declare class CompressedCubemapArray extends CompressedTextureLayered  {
...
*/
  ...
  connect<T extends SignalsOf<CompressedCubemapArray>>(signal: T, method: SignalFunction<CompressedCubemapArray[T]>): number;
