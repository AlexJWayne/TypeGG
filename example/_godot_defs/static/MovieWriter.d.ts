...
/**
 * Godot can record videos with non-real-time simulation. Like the `--fixed-fps` [url=$DOCS_URL/tutorials/editor/command_line_tutorial.html]command line argument[/url], this forces the reported `delta` in [method Node._process] functions to be identical across frames, regardless of how long it actually took to render the frame. This can be used to record high-quality videos with perfect frame pacing regardless of your hardware's capabilities.
 *
...
protected _get_audio_mix_rate(): int;
...
protected _get_audio_speaker_mode(): int;
